                        ...
                        <div>
                            ...
                            <div className="relative rounded-lg shadow-sm">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-10 pr-3 py-3 border border-slate-800 rounded-lg bg-slate-950 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all sm:text-sm"
